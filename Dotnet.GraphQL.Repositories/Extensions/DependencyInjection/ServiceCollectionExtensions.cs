using Dotnet.GraphQL.Repositories.Contexts;
using Microsoft.EntityFrameworkCore;
using Microsoft.EntityFrameworkCore.Infrastructure;
using Microsoft.Extensions.DependencyInjection;
using System;

namespace Dotnet.GraphQL.Repositories.Extensions.DependencyInjection
{
    public static class ServiceCollectionExtensions
    {
        ...
        public static IServiceCollection AddApplicationDbContext(this IServiceCollection services, Action<RepositoryOptions> optionsAction)
        {
            ...
            return services
                ...
                .AddDbContext<MyDbContext>(DbContextOptionsBuilderAction);
        }
        ...
        private static void SqlServerOptionsAction(SqlServerDbContextOptionsBuilder optionsBuilder)
            => optionsBuilder
                ...
                .MigrationsAssembly(typeof(MyDbContext).Assembly.GetName().Name);
    }
